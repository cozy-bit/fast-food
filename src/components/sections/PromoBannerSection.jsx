	...
	return (
		<>
			<section className=' bg-[#312F30]'>
				<div className='max-w-300 mx-auto flex items-center justify-center gap-40 bg-[#312F30]'>
					<img src={burger} alt='' className='h-125' />
					<aside className='text-white flex flex-col gap-4 mr-14 items-start'>
						...
						<div className='flex  gap-2 items-end text-[#F6762C] font-medium'>
							...
							<span className='text-[#F6762C]/70 text-[16px] line-through'>$8</span>
						</div>
						<Button />
					</aside>
				</div>
